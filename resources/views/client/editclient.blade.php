            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route("clientEdit") }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group"{{ $errors->has('company_name') ? ' has-error' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="company_name" type="text" class="form-control" name="company_name" value="{{$company_name}}"  required>
                            ...
                            <div class="form-group"{{ $errors->has('concert_funds') ? ' has-error' : '' }}>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <input id="concert_funds" type="text" class="form-control" name="concert_funds" placeholder="Concert Funds" value="{{$concert_funds}}" required>
                            ...
                            <div class="form-group"{{ $errors->has('representative_name') ? ' has-error' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="representative_name" type="text" class="form-control" name="representative_name" value="{{$representative_name}}"  required>
                            ...
                            <div class="form-group"{{ $errors->has('representative_surname') ? ' has-error' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="representative_surname" type="text" class="form-control" name="representative_surname" value="{{$representative_surname}}"  required>
                            ...
                            <div class="form-group"{{ $errors->has('other_contact') ? ' has-error' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="other_contact" type="textarea" class="form-control" name="other_contact" value="{{$other_contact}}"  required>
                                    </textarea>
