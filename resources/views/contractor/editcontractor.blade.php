        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit Contractor</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route("contractorEdit") }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group"{{ $errors->has('initial_payment') ? ' has-error' : '' }}>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                        ...
                                        <input id="initial_payment" type="text" class="form-control" name="initial_payment" placeholder="Advance Payment" value="{{$initial_payment}}" required>
                            ...
                            <div class="form-group"{{ $errors->has('full_payment') ? ' has-error' : '' }}>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                        <div class="input-group-addon"><span class="glyphicon glyphicon-gbp"></span></div>
                                        <input id="full_payment" type="text" class="form-control" name="full_payment" placeholder="Full Payment" value="{{$full_payment}}" required>
                            ...
                            <div class="form-group"{{ $errors->has('description') ? ' has-error' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="description" type="textarea" class="form-control" name="description" value="{{$description}}"  required>
                                    </textarea>
